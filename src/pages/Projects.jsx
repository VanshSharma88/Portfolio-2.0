...
const Projects = () => {
  const projects = [
    ...
    image: "https://i.ibb.co/ksLc5F0C/n1.jpg",
    ...
    },
    {
      ...
      image: 'https://i.ibb.co/Kz95BTKw/n2.jpg',
      technologies: ['React', 'Javascript', 'HTML' , 'CSS'],
      liveUrl: '#',
      githubUrl: '#',
      featured: true
    },
    {
      ...
      description: 'Trying to clone UI of Myntra',
      image: 'https://i.ibb.co/b55Wh32f/n3.jpg',
      technologies: ['React', 'Javascript', 'HTML' , 'CSS'],
      liveUrl: '#',
      githubUrl: '#',
      featured: false
    ...
    {
      id: 4,
      title: 'Capstone College Project',
      description: 'Converting Figma design into real functional website',
